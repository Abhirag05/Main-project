...
/**
 * Finance Admin Batches Page
 * 
 * Reuses the Centre Admin batch listing component with Finance role access.
 * The backend automatically filters eligible students by fee verification status.
 */
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">
              You don't have permission to access this page. Only Finance Admins
              can manage batches.
            </p>
          </div>
        </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-700">
              Manage batches for your centre (Finance Admin)
            </p>
          </div>
        </div>
        ...
        <div className="mt-8">
          {loading ? (
            ...
            <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
              ...
              <div className="mt-6">
                <button
                  onClick={() => router.push("/dashboards/finance/batches/create")}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {batches.map((batch) => (
                <BatchCard key={batch.id} batch={batch} baseUrl="/dashboards/finance/batches" />
              ))}
            </div>
          )}
        </div>
