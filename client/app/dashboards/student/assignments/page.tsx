...
export default function StudentAssignmentsPage() {
  ...
  const getStatusBadge = (assignment: Assignment) => {
    ...
    if (assignment.my_submission) {
      return <span className="px-2 py-1 text-xs font-semibold rounded-full bg-primary/10 text-primary">Submitted</span>;
    }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {filteredAssignments.length === 0 ? (
          <div className="bg-card rounded-lg shadow-md p-12 text-center">
            ...
            <h3 className="mt-2 text-sm font-medium text-foreground">No assignments found</h3>
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                  <div className="bg-secondary/50 rounded-lg p-3">
                    ...
                    <div className="font-medium text-foreground">{formatDate(assignment.due_date)}</div>
                  ...
                  <div className="bg-secondary/50 rounded-lg p-3">
                    ...
                    <div className="font-medium text-foreground">{assignment.max_marks}</div>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  <Link
                    ...
                    className="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md text-white bg-primary hover:bg-primary/90"
                  >
                  ...
                  {assignment.my_submission && !assignment.my_submission.is_evaluated && (
                    <Link
                      href={`/dashboards/student/assignments/${assignment.id}`}
                      className="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md text-foreground/80 bg-secondary hover:bg-muted"
                    >
                      Edit Submission
                    </Link>
                  )}
