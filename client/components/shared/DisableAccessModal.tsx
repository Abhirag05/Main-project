      ...
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full z-50">
                ...
                <div className="mt-2">
                  ...
                  <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-md">
                    ...
                    <ul className="mt-2 text-sm text-red-700 list-disc list-inside space-y-1">
                      ...
                      <li>Disable the student account</li>
                      <li>Mark status as disabled</li>
                    </ul>
                  </div>
                  <div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
                    <p className="text-xs text-yellow-700">
                      <strong>Note:</strong> You can re-enable access later if needed.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            ...
            >
              {isLoading ? "Disabling..." : "Disable Access"}
            </button>
            <button
              type="button"
              onClick={onCancel}
