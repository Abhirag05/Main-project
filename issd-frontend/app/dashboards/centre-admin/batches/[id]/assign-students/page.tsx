...
export default function AssignStudentsPage() {
  ...
  // Finish and go to assign mentor
  const handleContinueToMentor = () => {
    router.push(`/dashboards/centre-admin/batches/${batchId}/assign-mentor`);
  };
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 max-w-6xl mx-auto">
        ...
        {showPreview ? (
          <AssignedStudentsPreview
            ...
            onContinue={handleContinueToMentor}
          />
        ) : (
          <>
            {/* Selection Info Bar */}
