...
export default function FacultySubjectAssignmentsPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      if (userStr) {
        ...
        // In production, you'd check for faculty.view permission
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">
              ...
              Admins can manage faculty module assignments.
            </p>
          </div>
        </div>
      </DashboardLayout>
        ...
        <ConfirmDialog
          ...
          message={
            assignmentToDeactivate
              ? assignmentToDeactivate.is_active
                ? `Are you sure you want to deactivate the assignment of "${assignmentToDeactivate.subject?.name || assignmentToDeactivate.module?.name}" for this faculty member? The assignment will be marked as inactive but not permanently deleted.`
                : `Are you sure you want to reactivate the assignment of "${assignmentToDeactivate.subject?.name || assignmentToDeactivate.module?.name}" for this faculty member?`
              : ""
          }
          confirmText={
